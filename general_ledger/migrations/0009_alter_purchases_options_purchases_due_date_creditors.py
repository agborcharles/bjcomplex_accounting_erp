# Generated by Django 4.0.3 on 2022-03-04 13:57
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('general_ledger', '0008_remove_purchases_customer_institution_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_cr', models.CharField(blank=True, choices=[('Cash', 'Cash'), ('Creditors', 'Creditors')], default='', max_length=500, null=True, verbose_name='Account Credit')),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Creditors',
                'verbose_name_plural': 'PCreditors',
            },
        ),
    ]
